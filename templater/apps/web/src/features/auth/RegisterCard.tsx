...
export function RegisterCard() {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            // Здесь мы просто уходим на логин, контекст пока не трогаем
            navigate('/login')
        } catch (err) {
        ...
        <SectionCard
            ...
            actions={
                <Stack direction="row" spacing={2}>
                    ...
                    <Button variant="contained" disabled={isBusy || !email || password.length < 6} onClick={handleRegister}>
        ...
        >
            <Stack spacing={2.5}>
                ...
                <TextField
                    ...
                    type="password" fullWidth size="small" value={password} onChange={(e) => setPassword(e.target.value)}
